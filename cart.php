...
<?php
$sql = "SELECT name, product_id, mobile,address,pin,state,usercart,no,orderdate,price,payment,comment FROM test where usercart=$uid";
...
if ($result->num_rows > 0) {
   ...
   ?> <div align="right">
<a href="order.php" class="btn btn-info" role="button">Confirm Order</a>
</div>
<?php
}
