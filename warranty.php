...
if (isset($_POST['login'])) {
    ...
    $tagno = mysqli_real_escape_string($con, $_POST['tagno']);
     $result = mysqli_query($con, "SELECT * FROM warranty WHERE tagno = '" . $tagno."'");
    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-4 well">
            <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="loginform">
                <fieldset>
                    <legend>Check Warranty</legend>
                    
                    <div class="form-group">
                        <label for="name">Enter Service Tag number here</label>
                        <input type="text" name="tagno" placeholder="Enter Service Tag no`" required class="form-control" />
                    </div>
                    <br>
                    <br>
                    <div class="form-group">
                        <input type="submit" name="login" value="Check" class="btn btn-primary" />
                    </div>
                </fieldset>
            </form>
        </div>
