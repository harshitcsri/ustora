...
<?php
$sql = "SELECT id,name,email,mobile FROM users where id=$uid";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc())   {    ?>
            <tr>
                ...
                <td>
                    <a href="deleteuser.php?id=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm" href="delete.php"><span class="glyphicon glyphicon-trash" aria-hidden="true">
                    </span>
                    </a>
                </td>
